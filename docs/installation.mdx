...
Pre-built installers are available for all platforms. Download from the [GitHub Releases page](https://github.com/tempestai-dev/tempest/releases).
  ...
  <Tab title="Windows">
    ...
    <Steps>
      <Step title="Download the installer">
        From [Releases](https://github.com/tempestai-dev/tempest/releases), download the file named `tempest_x.x.x_x64-setup.exe` (where `x.x.x` is the version number).
      </Step>
  ...
  <Tab title="macOS">
    ...
    <Steps>
      ...
      <Step title="Download the disk image">
        From [Releases](https://github.com/tempestai-dev/tempest/releases), download:
  ...
  <Tab title="Linux">
    ...
    <Steps>
      <Step title="Download the AppImage">
        From [Releases](https://github.com/tempestai-dev/tempest/releases), download `tempest_x.x.x_amd64.AppImage`.
      </Step>
    ...
    <Steps>
      <Step title="Download the package">
        From [Releases](https://github.com/tempestai-dev/tempest/releases), download `tempest_x.x.x_amd64.deb`.
      </Step>
      <Step title="Install">
        <CodeBlock language="bash">
