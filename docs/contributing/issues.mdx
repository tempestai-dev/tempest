...
<Steps>
  ...
  <Step title="Search existing issues">
    Search [GitHub Issues](https://github.com/tempestai-dev/tempest/issues) for your error message or a description of the behavior. Add a comment to an existing issue rather than opening a duplicate.
  </Step>
