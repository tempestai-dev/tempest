...
**Token Intelligence** — a local code-knowledge graph that cuts redundant file reads across agent sessions. Early numbers: up to 86% reduction in context consumption, up to 92% fewer tool calls.
...
[Download Tempest v0.1.0 on GitHub.](https://github.com/tempestai-dev/tempest)
