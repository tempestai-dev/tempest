...
/**
 * New landing Button. Local fork of the shared shadcn button.
 *
 * Props on top of shadcn:
 *   compact    Smaller text (text-xs) and tighter focus/invalid rings (ring-1).
 *   uppercase  Applies text-transform: uppercase.
 *   mono       Uses Geist Mono instead of Geist Sans.
 *
 * All three are independent booleans, mix freely.
 *
 * Examples:
 *   <Button>Ship</Button>
 *   <Button compact>Ship</Button>
 *   <Button compact uppercase mono variant="outline">get started</Button>
 */
...
const compactClasses =
  "text-xs focus-visible:ring-1 aria-invalid:ring-1"
