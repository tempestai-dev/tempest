    ...
    <main>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: 'Paseo covers every device. Tempest cuts token cost — Windows-native, daemon-free, with a shared knowledge graph reducing usage by up to 86%.',
            url: `${SITE_URL}/tempest-vs-paseo`,
      ...
      <Container className="pb-16">
        ...
        <p className="text-base text-foreground max-w-2xl leading-relaxed">
          ...
          instead of re-reading files. Up to 86% fewer tokens. Up to 92% fewer tool calls.
