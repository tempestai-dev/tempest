...
export interface SupervisionState {
   ...
   * (`ATLAS_HOST_PPID`), or null when unknown — e.g. the standalone bundle,
 ...
 * (`ATLAS_PPID_POLL_MS`). A value of `0` disables the watchdog entirely
 ...
 * (`ATLAS_HOST_PPID`). Returns a positive integer PID, or null when
