 ...
 */
const RELAUNCH_GUARD_ENV = 'ATLAS_WASM_RELAUNCHED';
 ...
 */
export const HOST_PPID_ENV = 'ATLAS_HOST_PPID';
 ...
 * disabled via ATLAS_NO_RELAUNCH.
 *
...
export function relaunchWithWasmRuntimeFlagsIfNeeded(scriptPath: string): void {
  ...
  if (process.env.ATLAS_NO_RELAUNCH) return;
