// Encrypt / decrypt a JSON frame with the paired session key. Frames on
// the wire always look like { n: nonce_b64, c: box_b64 } — the outer JSON
// is what the router forwards; the plaintext inside is the RPC envelope
// defined in @tempest/core.
